...
- マークダウンからプレゼン資料を作れる`marp`というものがある
  - VS Code拡張でプレビューできるしかなり良さそう
  - エクスポートもVS Code拡張でできる。設定でエクスポート形式も変更できる
  - [あなたにMarpを使わせたくなる記事](https://zenn.dev/nana/articles/f5b03d9425d1eb)
